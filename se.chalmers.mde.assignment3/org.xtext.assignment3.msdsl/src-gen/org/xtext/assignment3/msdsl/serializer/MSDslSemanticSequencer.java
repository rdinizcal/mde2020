 ...
 */
package org.xtext.assignment3.msdsl.serializer;
...
public class MSDslSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	protected void sequence_Negation(ISerializationContext context, Negation semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getNegationAccess().getContainsInputConditionEStringParserRuleCall_1_0_1(), semanticObject.eGet(ManufacturingSystemPackage.Literals.NEGATION__CONTAINS, false));
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (input+=[InputCondition|EString] input+=[InputCondition|EString]* outputTypes=[WorkPieceType|EString]?)
	 */
	...
	protected void sequence_WorkPieceCondition(ISerializationContext context, WorkPieceCondition semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getWorkPieceConditionAccess().getNameEStringParserRuleCall_1_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getWorkPieceConditionAccess().getRequiresTypeWorkPieceTypeEStringParserRuleCall_3_0_1(), semanticObject.eGet(ManufacturingSystemPackage.Literals.WORK_PIECE_CONDITION__REQUIRES_TYPE, false));
		feeder.finish();
	}
	...
	protected void sequence_WorkPiece(ISerializationContext context, WorkPiece semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getWorkPieceAccess().getHasTypeWorkPieceTypeEStringParserRuleCall_3_0_1(), semanticObject.eGet(ManufacturingSystemPackage.Literals.WORK_PIECE__HAS_TYPE, false));
		feeder.finish();
	}
